...
const ROLE_TAG = {
  technician: { label: 'TECHNICIAN', className: 'bg-brand-light text-brand-dark' },
      ...
      <section className="flex w-full items-center justify-center p-6 lg:w-1/2">
        <div className="w-full max-w-md">
          <div className="mb-8 lg:hidden">
            <span className="text-2xl font-bold">glpi<span className="text-brand">-next</span></span>
          </div>
            ...
            {DEMO_USERS.map((u) => {
              ...
              return (
                <button
                  ...
                  className="group flex w-full items-center gap-4 rounded-2xl border border-black/10 bg-surface-1 p-4 text-left shadow-card transition-all hover:-translate-y-0.5 hover:border-brand/40 hover:shadow-cardHover disabled:opacity-60"
                >
