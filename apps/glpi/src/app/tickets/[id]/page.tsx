...
export default function TicketDetailPage() {
  ...
  return (
    <AppShell>
      <Link href="/tickets" className="text-sm font-medium text-brand hover:underline">← Tickets</Link>
      {!t ? (
            ...
            {t.canFollowup && t.status !== 'closed' && (
              <div className="mt-4 rounded-2xl bg-surface-1 p-4 shadow-card">
                <textarea
                  ...
                  rows={3}
                  className="w-full resize-y rounded-xl border border-black/10 bg-surface-0 px-3.5 py-2.5 text-sm outline-none focus:ring-2 focus:ring-brand/40"
                />
                <div className="mt-3 flex flex-wrap items-center gap-3">
                  ...
                  <select
                    ...
                    className="rounded-lg border border-black/10 bg-surface-0 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-brand/40"
                  >
                  ...
                  <button
                    ...
                    className="ml-auto rounded-lg bg-brand px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-brand-dark disabled:opacity-60"
                  >
            ...
            {t.asset && (
              <div className="rounded-2xl bg-surface-1 p-5 shadow-card">
                ...
                <div className="flex items-center gap-3">
                  <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-light text-lg">{t.asset.icon}</span>
                  <div>
