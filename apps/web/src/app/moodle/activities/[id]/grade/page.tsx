...
import { Skeleton, StatTile } from '@/components/moodle/ui'
  ...
  return (
    <AppShell>
      <div className="mb-8">
        {view ? (
          <>
            <Link href={`/moodle/courses/${view.activity.courseId}`} className="text-sm font-medium text-mbrand hover:underline">
              ← Back to course
            </Link>
                  ...
                  <li key={r.userId} className="grid gap-3 px-6 py-4 lg:grid-cols-[200px_110px_1fr_auto] lg:items-center">
                    ...
                    <div>
                      <input
                        ...
                        className="w-full rounded-lg border border-black/10 bg-surface-0 px-3 py-2 text-sm tabular-nums outline-none focus:ring-2 focus:ring-mbrand/40"
                      />
                    </div>
                    <input
                      type="text"
                      ...
                      className="w-full rounded-lg border border-black/10 bg-surface-0 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-mbrand/40"
                    />
                    <button
                      ...
                      className={`justify-self-end rounded-lg px-4 py-2 text-sm font-semibold transition-colors ${
                        saved[r.userId]
                          ...
                          : 'bg-mbrand text-white hover:bg-mbrand-dark disabled:opacity-60'
                      }`}
                    >
